...
## T2
#
struct Test2ProxGrad <: ProxGradExtrapolation end
mutable struct Test2ProxGradState <: ProxGradExtrapolationState end

extrapolation_state(::Test2ProxGrad, x, g) = Test2ProxGradState()
function extrapolation!(::Test2ProxGrad, state, extrastate, pb)
...
function extrapolation_state(o::MFISTA, x, g::Regularizer)
    return MFISTAState(extrapolation_state(o.acceleration, x, g), zero(x), zero(x))
end
